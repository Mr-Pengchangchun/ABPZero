...
namespace ABPCore.PhoneBook.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class PhoneBookRepositoryBase<TEntity> : PhoneBookRepositoryBase<TEntity, int>, IRepository<TEntity>
